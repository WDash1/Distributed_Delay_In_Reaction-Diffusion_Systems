...
sol = computeFixedDelayLISchnakenbergTrajectory(a,b,tau,max(t_mesh), u0,v0,10e-18,10e9);
...
for sigma_index = 1:sigma_amt
    ...
    sol = computeDistributedDelayLISchnakenbergTrajectory(a,b,double(delay_values), double(weights), max(t_mesh), u0,v0,10e-18,10e9);
    current_y_values = deval(sol,t_mesh);
